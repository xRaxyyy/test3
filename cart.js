    ...
    cart.forEach(item => {
        ...
        <div class="product">
            ...
            <div class="details-box">
                <div id="product-info">
                    <a href="../template.html?product=${productLink}"><h1>${item.name}</h1></a>
...
document.addEventListener('click', (event) => {
    ...
    if (event.target.closest('#minus-btn')) {
        const productDiv = event.target.closest('.product'); // Get the parent product div
        const cartInput = productDiv.querySelector('#cart-input');
